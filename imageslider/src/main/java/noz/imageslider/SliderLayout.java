...
import noz.imageslider.Animations.BaseAnimationInterface;
import noz.imageslider.Indicators.PagerIndicator;
import noz.imageslider.SliderTypes.BaseSliderView;
import noz.imageslider.Transformers.AccordionTransformer;
import noz.imageslider.Transformers.BackgroundToForegroundTransformer;
import noz.imageslider.Transformers.BaseTransformer;
import noz.imageslider.Transformers.CubeInTransformer;
import noz.imageslider.Transformers.DefaultTransformer;
import noz.imageslider.Transformers.DepthPageTransformer;
import noz.imageslider.Transformers.FadeTransformer;
import noz.imageslider.Transformers.FlipHorizontalTransformer;
import noz.imageslider.Transformers.FlipPageViewTransformer;
import noz.imageslider.Transformers.ForegroundToBackgroundTransformer;
import noz.imageslider.Transformers.RotateDownTransformer;
import noz.imageslider.Transformers.RotateUpTransformer;
import noz.imageslider.Transformers.StackTransformer;
import noz.imageslider.Transformers.TabletTransformer;
import noz.imageslider.Transformers.ZoomInTransformer;
import noz.imageslider.Transformers.ZoomOutSlideTransformer;
import noz.imageslider.Transformers.ZoomOutTransformer;
import noz.imageslider.Tricks.FixedSpeedScroller;
import noz.imageslider.Tricks.InfinitePagerAdapter;
import noz.imageslider.Tricks.InfiniteViewPager;
import noz.imageslider.Tricks.ViewPagerEx;

/**
 * Created by CLient-Pc on 13/10/2016.
 */
/**
 * SliderLayout is compound layout. This is combined with {@link noz.imageslider.Indicators.PagerIndicator}
 * and {@link noz.imageslider.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * {@link noz.imageslider.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link noz.imageslider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link noz.imageslider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link noz.imageslider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link noz.imageslider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link noz.imageslider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link noz.imageslider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link noz.imageslider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see noz.imageslider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link noz.imageslider.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mViewPager = (InfiniteViewPager)findViewById(R.id.noz_slider_viewpager);
     ...
     * {@link noz.imageslider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link noz.imageslider.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link noz.imageslider.Indicators.PagerIndicator} instance.
