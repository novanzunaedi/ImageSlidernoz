package noz.imageslider.Indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    /**
     * bind this Indicator with {@link noz.imageslider.Tricks.ViewPagerEx}
     */
    ...
    /**
     *This value is from {@link noz.imageslider.SliderAdapter} getRealCount() represent
     *
